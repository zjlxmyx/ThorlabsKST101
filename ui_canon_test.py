...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_score.setGeometry(QtCore.QRect(240, 530, 381, 91))
        font = QtGui.QFont()
        font.setPointSize(25)
        self.label_score.setFont(font)
        self.label_score.setObjectName("label_score")
        self.pushButton_autoFocus = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_autoFocus.setGeometry(QtCore.QRect(730, 700, 191, 61))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.pushButton_autoFocus.setFont(font)
        self.pushButton_autoFocus.setObjectName("pushButton_autoFocus")
        self.pushButton_up = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_up.setGeometry(QtCore.QRect(960, 640, 70, 70))
        self.pushButton_up.setObjectName("pushButton_up")
        self.pushButton_down = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_down.setGeometry(QtCore.QRect(960, 730, 70, 70))
        ...
        self.pushButton_autoFocus.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_autoFocus.setText(_translate("MainWindow", "Auto Focus"))
